...
# Local imports
from ml_models import InterfaceBaseMLModel, MLModelRepository, \
    LinearRegressionModel, RandomForestModel, SVMModel
...
def get_model_by_name(model_type: str, n_estimators=100,
    random_state=42) -> InterfaceBaseMLModel:
    model_map = {
        "Linear Regression": LinearRegressionModel,
        "Random Forest Regressor": lambda: RandomForestModel(n_estimators,
                                                             random_state),
...
def train_model(X_train, Y_train, model_type, n_estimators=100,
    random_state=42) -> InterfaceBaseMLModel:
    """
    Trains the model
    Args:
